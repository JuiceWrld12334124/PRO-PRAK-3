...
<section class="overons-head bg-primary py-8">
    <div class="container grid">
        <div>
            ...
            <p class="lead">
                Heb je vragen? Of wil je meer weten over iets? Dan ben je op de juiste plek
            </p>
        </div>
        <img src="./img/software-development-icon-8.jpg" alt="">
    </div>
</section>
...
<section class="overons-sub-head bg-light py-4 landing-head">
    <div class="container grid">
        <div>
            ...
            <p class="lead white">
                Blijven je vragen onbeantwoord en loop je vast? Dan zullen onze experts je helpen!
            </p>
...
<section class="openingstijde bg-light p-3">
    <div class="container grid grid-3 cardflex">
        ...
        <div class="container grid news-card text-center">
            <img class="blank" src="./img/image-blog-future-software-development.png" alt="">
        </div>
    </div>
</section>
